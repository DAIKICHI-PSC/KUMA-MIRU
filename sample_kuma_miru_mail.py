...
#テキストファイルを作成後、python.exe 「ファイルのパス」/sample_kuma_miru_mail.pyを記述し、ファイルの拡張子を.batに変更して下さい（バッチファイルの作成）。
#ファイル名の例：sample_kuma_miru_mail.bat
#記述の例：python.exe c:/muma_miru/sample_kuma_miru_mail.py
...
#スタートアップフォルダへの登録方法3：先程作成したsample_kuma_miru_mail.batをスタートアップフォルダに移動します。
