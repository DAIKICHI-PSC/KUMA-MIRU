...
.MsoChpDefault
 ...
 /* Page Definitions */
 @page
	{mso-footnote-separator:url("ＫＵＭＡＭＩＲＵ.files/header.htm") fs;
	mso-footnote-continuation-separator:url("ＫＵＭＡＭＩＲＵ.files/header.htm") fcs;
	mso-endnote-separator:url("ＫＵＭＡＭＩＲＵ.files/header.htm") es;
	mso-endnote-continuation-separator:url("ＫＵＭＡＭＩＲＵ.files/header.htm") ecs;}
@page WordSection1
...
<p class=MsoNormal><span lang=EN-US>excutable_files.zip</span>　圧縮された三つの実行ファイル（本フォルダに解凍すれば即時に運用可能）</p>
...
<p class=MsoNormal><span lang=EN-US>yolov4.weights</span>　<span lang=EN-US>AI</span>の学習済モデル</p>
