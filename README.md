...
<link rel=File-List href="ＫＵＭＡＭＩＲＵ.files/filelist.xml">
<link rel=themeData href="ＫＵＭＡＭＩＲＵ.files/themedata.thmx">
<link rel=colorSchemeMapping href="ＫＵＭＡＭＩＲＵ.files/colorschememapping.xml">
<!--[if gte mso 9]><xml>
 <w:WordDocument>
...
lang=EN-US>900</span>ミリ秒×カメラの台数となり、<span lang=EN-US>PC</span>本体とカメラ１台の費用は<span
lang=EN-US>3</span>万円前後となります）（<span lang=EN-US>AMD</span>社の<span lang=EN-US>Ryzen7PRO6850H</span>の処理時間は約<span
lang=EN-US>250</span>ミリ秒×カメラの台数となり、<span lang=EN-US>PC</span>本体とカメラ<span
...
<p class=MsoNormal>［本体ファイルのダウンロード先］</p>

<p class=MsoNormal><span lang=EN-US>main.zip(https://github.com/DAIKICHI-PSC/KUMA-MIRU/archive/refs/heads/main.zip)</span></p>

<p class=MsoNormal>［各ファイルの説明］</p>

<p class=MsoNormal><span lang=EN-US>materials</span>フォルダ　資料が入っています</p>

<p class=MsoNormal><span lang=EN-US>0.mp3</span>　犬の効果音データ</p>

<p class=MsoNormal><span lang=EN-US>1.mp3</span>　犬の効果音データ</p>

<p class=MsoNormal><span lang=EN-US>2.mp3</span>　犬の効果音データ</p>

<p class=MsoNormal><span lang=EN-US>coco.names</span>　物体検出名のリスト</p>

<p class=MsoNormal><span lang=EN-US>excutable_files.zip(https://github.com/DAIKICHI-PSC/KUMA-MIRU/releases/download/VERSION1.0/excutable_files.zip)</span>　圧縮された三つの実行ファイル（ダウンロードして、本フォルダに解凍すれば即時に運用可能）</p>
...
<p class=MsoNormal><span lang=EN-US>sample_settings_sound.txt</span>　<span
lang=EN-US>sample_kuma_miru_sound</span>の設定ファイル</p>

<p class=MsoNormal><span lang=EN-US>settings.txt</span>　共通の設定ファイル</p>

<p class=MsoNormal><span lang=EN-US>yolov4.cfg</span>　<span lang=EN-US>AI</span>の学習モデル</p>

<p class=MsoNormal><span lang=EN-US>yolov4.weights(https://github.com/DAIKICHI-PSC/KUMA-MIRU/releases/download/VERSION1.0/yolov4.weights)</span>　<span lang=EN-US>AI</span>の学習済モデル（ダウンロードして、同じフォルダに入れて下さい）</p>
...
<p class=MsoNormal>［appreciation（感謝）］</p>
